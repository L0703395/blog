...
const LeafGraphic: React.FC<{ style?: React.CSSProperties }> = ({ style }) => (
  <svg viewBox="0 0 100 100" width={80} height={80} style={{ position: "absolute", opacity: 0.08, pointerEvents: "none", ...style }}>
...
function App() {
  ...
  return (
    <div style={{ background: palette.bg, minHeight: "100vh", color: palette.ink, position: "relative" }}>
      ...
      <div style={{ background: `radial-gradient(1200px 400px at 50% -50px, ${palette.gold}33, transparent 60%), linear-gradient(180deg, #FFF 0%, ${palette.bg} 100%)`, borderBottom: `1px solid ${palette.accent2}33`, position: "relative", zIndex: 1 }}>
        <div style={{ maxWidth: 960, margin: "0 auto", padding: "40px 20px 24px" }}>
          ...
          <div style={{ marginTop: 16, padding: 12, border: `1px solid ${palette.accent2}55`, borderRadius: 12, background: `linear-gradient(180deg, #fff, ${palette.bg})`, boxShadow: `0 2px 8px ${palette.accent2}22` }}>
